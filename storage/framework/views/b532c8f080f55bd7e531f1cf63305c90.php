        ...
        <div class="form-step" id="step2">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div>
                    ...
                    <input type="text" name="gaji" class="custom-input-admin" value="<?php echo e(old('gaji')); ?>" placeholder="Rp 5.000.000">
                </div>
                <div >
                    <label class="label-admin">Link LinkedIn</label>
                    <input type="url" name="linkedin" class="custom-input-admin" value="<?php echo e(old('linkedin')); ?>" placeholder="https://linkedin.com/in/username">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 25px;">
                ...
                <div style="display: flex; flex-direction: column; gap: 15px;">
                    <div>
                        ...
                        <input type="text" name="kota" id="kota" class="custom-input-admin" value="<?php echo e(old('kota')); ?>" placeholder="Ketik nama kota...">
                    </div>
                    <div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Aplikasi_Skripsi\gis-alumni\resources\views/admin/create.blade.php ENDPATH**/ ?>