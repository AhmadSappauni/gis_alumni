<aside class="sidebar glass-panel">
    ...
    <nav class="nav-menu">
        <a href="{{ route('admin.alumni.index') }}" class="nav-item {{ request()->routeIs('admin.alumni.index') ? 'active' : '' }}">
        ...
        <div class="nav-dropdown {{ request()->routeIs('admin.alumni.create') || request()->routeIs('admin.alumni.import') ? 'active' : '' }}">
            ...
            <div class="dropdown-container">
                <a href="{{ route('admin.alumni.create') }}" class="dropdown-item {{ request()->routeIs('admin.alumni.create') ? 'current' : '' }}">
                    <div class="dot"></div> Tambah Perorang
                </a>
                <a href="{{ route('admin.alumni.import') }}" class="dropdown-item {{ request()->routeIs('admin.alumni.import') ? 'current' : '' }}">
